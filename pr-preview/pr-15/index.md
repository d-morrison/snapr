...
[![Codecov test
coverage](https://codecov.io/gh/d-morrison/snapr/graph/badge.svg)](https://app.codecov.io/gh/d-morrison/snapr)

The goal of snapr is to provide convenient snapshot testing functions
for R packages:

- `expect_snapshot_data()` - for data.frames (adapted [with
...
- `expect_snapshot_object()` - generalizes `expect_snapshot_data()` for
  use with any R object
